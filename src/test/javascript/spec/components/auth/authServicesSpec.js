...
describe('Services Tests ', function () {
    ...
    describe('Auth', function () {
        ...
        beforeEach(inject(function($injector, localStorageService, Auth, AuthServerProvider) {
            ...
            $httpBackend.expectGET('i18n/he/global.json').respond(200, '');
            $httpBackend.expectGET('i18n/he/language.json').respond(200, '');
            $httpBackend.expectGET('scripts/components/navbar/navbar.html').respond({});
            $httpBackend.expectGET('i18n/he/global.json').respond(200, '');
            $httpBackend.expectGET('i18n/he/language.json').respond(200, '');
            $httpBackend.expectGET('i18n/he/main.json').respond(200, '');
